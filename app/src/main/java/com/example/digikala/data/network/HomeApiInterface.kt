...
interface HomeApiInterface {
    ...
    suspend fun getSpecialOffers(): Response<ResponseResult<List<StoreProduct>>>

    @GET("v1/getSuperMarketAmazingProducts")
    suspend fun getSpecialSupermarketOffers(): Response<ResponseResult<List<StoreProduct>>>
